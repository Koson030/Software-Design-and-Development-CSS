...
<body>
    <div class="stats-container">
        ...
        <div class="stat-box">
            <div class="stat-number">9.8k</div>
            <div class="stat-label">ยอดขาย</div>
        </div>
        <div class="stat-box">
...
```
![image](https://github.com/user-attachments/assets/d6b6ddbe-c759-405e-8860-b41af33d0507)
...
<body>
    <article class="blog-post">
        <header class="post-header">
            <h1 class="post-title">วิธีการเขียนบทความที่น่าสนใจ</h1>
            <div class="post-meta">โพสต์เมื่อ 1 มิถุนายน 2025 | โดย ผู้เขียน นายโกศล เพ็งพิพัฒน์</div>
        </header>
...
```
![image](https://github.com/user-attachments/assets/f8ad09f8-db0b-41a2-81c6-96c9f69c35bf)
...
<body>
    <div class="product-grid">
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/products/MVG0302.png');"></div>
            <div class="product-details">
                <h3 class="product-title">MVG0302-ดาบแกร่งแห่งการเรียงตัว ลากรันจาด</h3>
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/products/MVG0249.png');"></div>
            <div class="product-details">
                <h3 class="product-title">MVG0249-สตาร์เวเดอร์ เคออสเบรกเกอร์ดราก้อน</h3>
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/products/MVG0203.png');"></div>
            <div class="product-details">
                <h3 class="product-title">MVG0203-สเป็คทรัล ดุ๊ค ดราก้อน</h3>
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/products/MVG0200.png');"></div>
            <div class="product-details">
                <h3 class="product-title">MVG0200-แซงค์ทัวรี่การ์ดดราก้อน</h3>
...
```
![image](https://github.com/user-attachments/assets/313cb43c-3143-4cb1-b122-8459012380ae)
...
```
![image](https://github.com/user-attachments/assets/7f60ab39-0917-4e2e-b0d3-b2db6e686867)
